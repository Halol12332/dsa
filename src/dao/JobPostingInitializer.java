...
//  Method to return a collection of with hard-coded entity values
  public void initializeJobPosts() {
    ...
    jList.add(new JobPostings("J002", "Data Scientist", "Data interpretation and visualization", "Kuala Lumpur", "IBM", "Python, Machine Learning, SQL, Tableau", "Full-Time", 6500.00));
    jList.add(new JobPostings("J003", "Web Designer", "Create custom E-commerce websites", "Selangor", "WD", "HTML, CSS, Adobe XD, JavaScript", "Part-Time", 4800.00));
